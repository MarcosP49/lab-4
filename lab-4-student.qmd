...
#| label: load-data
#| eval: false
data_Buoy <- read_table("C:/Users/marco/OneDrive/Desktop/STAT_210_Spring_2025/Videos/Week_5/lab-4/data-raw/buoy_2024.txt", comment = "#")
...
#| label: clean-names
#| eval: false
data_Buoy <- janitor::clean_names(data_Buoy)
```
...
#| eval: false
write_csv(data_Buoy, "C:/Users/marco/OneDrive/Desktop/STAT_210_Spring_2025/Videos/Week_5/lab-4/data-raw/buoy_update.csv")
```
...
#| eval: false
buoy_update <- read_csv("C:/Users/marco/OneDrive/Desktop/STAT_210_Spring_2025/Videos/Week_5/lab-4/data-raw/buoy_update.csv", col_types = cols(.default = "c"), na = c("99", "999"))
...
write_csv(buoy_final, "C:/Users/marco/OneDrive/Desktop/STAT_210_Spring_2025/Videos/Week_5/lab-4/data-new/buoy_final.csv")
```
...
buoy_data = read_csv("C:/Users/marco/OneDrive/Desktop/STAT_210_Spring_2025/Videos/Week_5/lab-4/data-new/buoy_final.csv")

buoy_data$fmm <- factor(buoy_data$mm, levels = 1:12)

ggplot(buoy_data, aes(x = as.numeric(mm), y = atmp, color = fmm)) +
  geom_jitter(width = 0.2, height = 0, alpha = 0.3) + 
  geom_smooth(method = "loess", color = "black") + 
  scale_color_manual(values = c("1" = "darkorchid4", "2" = "darkorchid", "3" = "mediumpurple", "4" = "slateblue", "5" = "steelblue", "6" = "aquamarine3", "7" = "darkseagreen3", "8" = "palegreen3", "9" = "palegreen", "10" = "chartreuse3", "11" = "olivedrab2", "12" = "yellow2")) + 
  labs(title = "Monterey Bay Canyon Air Temperature in 2024",
       x = "Month in 2024",
...
> My data is the Rolling Stones Top 500 Albums Rankings. It compiles 3 of the Rolling Stone's lists: from 2003, 2012, and 2020. It also has information about the albums, like the time spent on the billboard, spotify popularity rankings, and information about the artist(s). One research question I could try to answer is a relationship between placement on the list and billboard/spotify popularity. Another question I could try to answer is the distribution of genres in the top 500 list. 
